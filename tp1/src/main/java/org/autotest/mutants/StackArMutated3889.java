 ...
 */
public class StackArMutated3889 extends org.autotest.Stack {
    ...
    public StackArMutated3889() {
        this(org.autotest.mutants.StackArMutated3889.DEFAULT_CAPACITY);
    }

    public StackArMutated3889(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated3889 other = ((org.autotest.mutants.StackArMutated3889) (obj));
        if (true) {
            return false;
        }
