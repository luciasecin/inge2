 ...
 */
public class StackArMutated8943 extends org.autotest.Stack {
    ...
    public StackArMutated8943() {
        this(org.autotest.mutants.StackArMutated8943.DEFAULT_CAPACITY);
    }

    public StackArMutated8943(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated8943 other = ((org.autotest.mutants.StackArMutated8943) (obj));
        if (false) {
            return false;
        }
